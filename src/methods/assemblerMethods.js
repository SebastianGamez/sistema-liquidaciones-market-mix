...
const assemblerMethods = {
    ...
    calculateAssemblerHourValue() {
        ...
        const assemblerSalary = this.globalVariables.assembler.salary;
    ...
    calculateAssemblerShoesBonus() {
        ...
        const shoesAssemblerPrice = this.globalVariables.assembler.shoesAssemblerPrice;
    ...
    calculateAssemblerSneakersBonus() {
        ...
        const sneakersAssemblerPrice = this.globalVariables.assembler.sneakersAssemblerPrice;
    ...
    validateMaxAssemblers() {
        ...
        const { assembler } = this.globalVariables;
